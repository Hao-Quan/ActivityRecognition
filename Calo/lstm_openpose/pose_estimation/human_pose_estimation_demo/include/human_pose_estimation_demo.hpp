...
/// @brief Message for showing keypoints index
static const char show_keypoints_index_message[] = "Optional. Show keypoints index on the rendered image.";

/// @brief Message for rendering x coordinates
static const char show_x_coordinates_message[] = "Optional. Show x coordinates on the rendered image.";
...
/// @brief Defines flag to render keypoints index <br>
/// It is an optional parameter
DEFINE_bool(k, false, show_keypoints_index_message);

/// @brief Defines flag to render x coordinates <br>
/// It is an optional parameter
DEFINE_bool(x, false, show_x_coordinates_message);
...
static void showUsage() {
    ...
    std::cout << "    -k                         " << show_keypoints_index_message << std::endl;
    std::cout << "    -x                         " << show_x_coordinates_message << std::endl;
}
